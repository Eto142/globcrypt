...
<section class="wrapper">
	...
	<div class="abt-lp">
		<h1 class="about-main-title">
			FAQ  Global Crypto Organization World Wide         
		</h1>
	</div>
	<!-- ===================================About us section ========================= -->
	...
	<section class="container">
		...
		<div class="accordion" id="accordionExample">
			<div class="card">
				...
				<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
					<div class="card-body lite-ash">
						There are risks in Trading all assets, that is exactly why there is Global Crypto Organization World Wide, all trade risk are borne by us, if there is any loss that stalls the trading,the Investor will be Refunded his Capital.
					</div>
				</div>
			</div>
			<!-- ========================================================================================================== -->
			...
			<div class="card">
				...
				<div id="collapsefour" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
					<div class="card-body">
						Deposits and Withdrawals to and from InterconFxBots  are processed through Bitcoin & Ethereum.
					</div>
				</div>
			</div>
		</div>
		...
		<!-- ==================================================================================================================================================== -->
		<center>
			<h2> <b> Withdrawal Questions </b></h2>
		</center>
		<br />
		<div class="accordion" id="accordionExample">
			<div class="card">
