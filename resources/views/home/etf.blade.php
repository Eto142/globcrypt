		...
		<div class="col-md-8 col-sm-12 col-crypto">
			<div class="container">
				...
				<div style="padding: 20px;">
					...
					<p class="t-p">InterconFxBots  customers enjoy high standard customer support around the clock via email and chat. Our representatives will gladly answer all of your questions..</p>
					<br />
				</div>
			</div>
			<!-- end container -->
