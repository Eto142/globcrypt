...
<head>
    ...
    <!-- Page Title  -->
    <title>Dashboard |  Quintessenceoptionss</title>
    <!-- StyleSheets  -->
...
<img class="logo-dark" style="width:192px; height:62px;" src="https:// Quintessenceoptionss.net/io.png"/>
                                            ...
                                            <ul class="panel2">
                                                ...
                                                <li class="nk-menu-item">
                                                    <a href="crypto/BOT.php" class="nk-menu-link">
                                                        <span class="nk-menu-text">Quintessenceoptions BOT 3.5</span>
                                                    </a>
                                                </li>
                                            </ul>
                                            <div class="nk-profile-content toggle-expand-content" data-content="sidebarProfile">
                ...
                <div class="nk-footer">
                    <div class="container-fluid">
                        <div class="nk-footer-wrap">
                            <div class="nk-footer-copyright"> &copy; 2024  Quintessenceoptions.
                            </div>
...
<a href="mailto:'support@ Quintessenceoptionss.net'"><img src="../../emailpng.png" class="feedback" alt="email"/></a>
</div>
        <style>
         .feedback {
             width:62px;
