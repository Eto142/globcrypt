...
<body class='respond' leftmargin='0' topmargin='0' marginwidth='0' marginheight='0'>
                    ...
                    <tr>
                        <td align='center' style='color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;'
                            ...
                            <div style='line-height: 35px'>
                                ...
                                Don't miss out the juiciest offer with <span style='color: #5caad2;'>Swift Define</span>
 ...
 $message .= "</p>
                                        <p style='line-height: 24px; margin-bottom:20px;'>
                                             We would like to hear from you. For any questions, suggestions or comments, please contact our media personnel Team via our contact form at
